			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事各種專業、科學及技術服務之行業均屬之，如法律及會計、企業管理及管理顧問、建築及工程服務、技術檢測及分析、研究發展、廣告及市場研究、專門設計及獸醫服務等。 
					</p>
				</div>
				<img src="專業科學.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
