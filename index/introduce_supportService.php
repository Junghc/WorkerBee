			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事支援一般企業運作之各種活動（少部分亦支援家庭）之行業均屬之，如租賃、就業服務、旅遊、保全及私家偵探、建築物及綠化服務，以及辦公室行政服務等。 
					</p>
				</div>
				<img src="支援服務業.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
