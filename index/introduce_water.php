			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事用水供應、廢（污）水處理、廢棄物之清除、搬運及處理、污染整治之行業均屬之。資源回收物分類及再製成原料亦歸入本類。
					</p>
				</div>
				<img src="用水整治.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
