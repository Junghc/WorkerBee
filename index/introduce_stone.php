			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事石油、天然氣、砂、石及黏土等礦物及土石之探勘、採取、初步處理（如碎解、洗選等處理作業）及準備作業（如除土、開坑、掘鑿等礦場工程）等行業均屬之。 
					</p>
				</div>
				<img src="土石採取.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
