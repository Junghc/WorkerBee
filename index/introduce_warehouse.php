			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事以各種運輸工具提供定期或不定期之客貨運輸及其運輸輔助、倉庫經營、郵政及快遞等行業均屬之。附駕駛之運輸設備租賃亦歸入本類。 
					</p>
				</div>
				<img src="倉儲運輸.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
