			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事資訊及通訊傳播之行業均屬之，如出版、影片服務、聲音錄製及音樂出版、傳播及節目播送、電信、電腦系統設計、資料處理及資訊供應服務等。 
					</p>
				</div>
				<img src="資通傳播.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
	<div class="row mb-2 pb-3 text-center" style="font-family:微軟正黑體 Light;d">
		<div class="col-md-3"></div>
		<div class="col-md-2">
			<button type="button" class="btn btn-dark btn-lg btn-block">相關薪資</button>
		</div>
		<div class="col-md-2">
			<button type="button" class="btn btn-dark btn-lg btn-block">工作滿意度</button>
		</div>
		<div class="col-md-2">
		<form action="whichCourse.php" method="get">
			<button type="submit" class="btn btn-dark btn-lg btn-block" name="information" value="資訊及通訊傳播">相關課程</button>
			</form>
		</div>
		<div class="col-md-3"></div>
	</div>
