			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事金融中介及其輔助活動（含保險業務及退休基
						金）均屬之。持有資產之活動，如金融控股公司，以
						及信託、基金及其他金融工具之活動亦歸入本類。 
					</p>
				</div>
				<img src="金融保險.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
	<div class="row mb-2 pb-3 text-center" style="font-family:微軟正黑體 Light;d">
		...
		<div class="col-md-2">
			<form action="whichCourse.php" method="get">
				<button type="submit" class="btn btn-dark btn-lg btn-block" name="financial" value="金融及保險業">相關課程</button>
			</form>
		</div>
		<div class="col-md-3"></div>
	</div>
