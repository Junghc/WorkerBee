...
<body>
			...
			<div class="card flex-md-row mb-4 box-shadow h-md-250">
				<div class="card-body d-flex flex-column text-center">
					...
					<p class="card-text mb-auto py-5" style="font-family:微軟正黑體;">
						凡從事建築及土木工程之興建、改建、修繕等及其專門營造之行業均屬之。整體性建築工程應歸入41中類「建築工程業」，整體性土木工程應歸入42中類「土木工程業」，僅從事建築及土木工程之特定部分工程者應歸入43中類「專門營造業」。附操作員之營造設備租賃亦歸入本類。 
					</p>
				</div>
				<img src="營造業.jpg" alt="" class="card-img-right flex-auto d-none d-md-block" style="width:70%; height:80%">
			</div>
		</div>
		<div class="col-md-2"></div>
	</div>
	<div class="row mb-2 pb-3 text-center" style="font-family:微軟正黑體 Light;d">
		...
		<div class="col-md-2">
			<button type="button" class="btn btn-dark btn-lg btn-block">相關課程</button>
		</div>
		<div class="col-md-3"></div>
	</div>
	<!--bootstrap JS-->
