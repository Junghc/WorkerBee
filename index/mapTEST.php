...
<html>
  ...
  <body>
    ...
    <b>Start: </b>
    <select id="start">
      <option value="台灣新北市泰山區貴子里致遠新村55之1號">台北</option>
    ...
    <b>End: </b>
    <select id="end">
      <option value="台灣桃園市楊梅區幼獅路二段3號">桃園</option>
    ...
    <script>
      function initMap() {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 13,
          center: {lat: 25.047781, lng: 121.517031}
        });
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA4sYAzrEUUWRxq4jI17O82NyYilKj0tMU&callback=initMap">
    </script>
  </body>
</html>